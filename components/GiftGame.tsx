        ...
        <div className="h-full flex flex-col space-y-6">
            <div className="glass-card p-6 rounded-3xl flex items-center justify-between shadow-xl">
                ...
                {!isPlaying ? (
                    <button
                        onClick={startGame}
                        className="shine-effect px-8 py-3 bg-stone-950 text-white rounded-xl font-bold shadow-lg hover:scale-105 transition-all"
                    >
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="text-right">
                            <p className="text-[10px] uppercase tracking-widest font-bold text-stone-400">Next Reward</p>
                            <p className="text-xs font-bold text-stone-900">{levelInfo.gift}</p>
                        </div>
            ...
            >
                {!isPlaying && timeLeft === 30 && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                        ...
                        <h2 className="text-3xl font-serif font-bold text-stone-900 mb-4">Genna Gift Catch</h2>
                        <p className="text-stone-600 max-w-sm mb-8 font-medium">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-left max-w-md">
                            <div className="text-[10px] font-bold text-stone-400 uppercase tracking-widest col-span-2 mb-2">Rewards</div>
                            <div className="text-xs font-medium">100+ points: Netela</div>
                            <div className="text-xs font-medium">250+ points: Meskel Cross</div>
                            <div className="text-xs font-medium">500+ points: Royal Gabi</div>
                            <div className="text-xs font-medium">800+ points: Coffee Set</div>
                        </div>
                    </div>
                )}
                                        ...
                                        >
                                            ...
                                            {!hasClickedBox && (
                                                <motion.div
                                                    ...
                                                    className="absolute inset-0 border-4 border-amber-500/30 rounded-full scale-150 pointer-events-none"
                                                />
                                            )}
                                        </motion.div>
                                    ) : (
